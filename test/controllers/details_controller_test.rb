...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post details_url, params: { detail: { admin_user_id: @detail.admin_user_id, area: @detail.area, descripcion: @detail.descripcion, item_id: @detail.item_id, pfecha: @detail.pfecha } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { admin_user_id: @detail.admin_user_id, area: @detail.area, descripcion: @detail.descripcion, item_id: @detail.item_id, pfecha: @detail.pfecha } }
